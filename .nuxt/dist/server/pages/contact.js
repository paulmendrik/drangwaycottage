...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/contact.vue?vue&type=template&id=0d607722&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._l((_vm.slices),function(slice,index){return _vm._ssrNode("<div>","</div>",[(slice.slice_type === 'banner')?[_c('Banner',{attrs:{"slice":slice}})]:_vm._e()],2)}),_vm._ssrNode(" "),_c('Nav'),_vm._ssrNode(" <h1 class=\"uk-heading-primary\">"+_vm._ssrEscape(_vm._s(_vm.$prismic.asText(_vm.contact.title)))+"</h1> <div"+(_vm._ssrAttr("data-src",_vm.contact.image.url))+" uk-img class=\"uk-height-large uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light\"></div> "),_vm._ssrNode("<div uk-grid class=\"uk-grid-collapse uk-margin-top\">","</div>",[_vm._ssrNode("<div class=\"uk-width-1-4 uk-flex-last\">","</div>",[_c('prismic-image',{staticClass:"uk-margin-bottom",attrs:{"field":_vm.contact.contentimage01,"uk-img":""}}),_vm._ssrNode(" "),_c('prismic-image',{staticClass:"uk-margin-bottom",attrs:{"field":_vm.contact.contentimage02,"uk-img":""}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"uk-width-3-4 uk-flex-first\">","</div>",[_c('prismic-rich-text',{attrs:{"field":_vm.contact.content}})],1)],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/contact.vue?vue&type=template&id=0d607722&
