...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=d6ebe862&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._l((_vm.slices),function(slice,index){return _vm._ssrNode("<div>","</div>",[(slice.slice_type === 'banner')?[_c('Banner',{attrs:{"slice":slice}})]:_vm._e()],2)}),_vm._ssrNode(" "),_c('Nav'),_vm._ssrNode(" <h1 class=\"uk-heading-primary\">"+_vm._ssrEscape(_vm._s(_vm.$prismic.asText(_vm.home.title)))+"</h1> <div"+(_vm._ssrAttr("data-src",_vm.home.image.url))+" uk-img class=\"uk-height-large uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light\"></div> "),_c('prismic-rich-text',{attrs:{"field":_vm.home.content}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=d6ebe862&
