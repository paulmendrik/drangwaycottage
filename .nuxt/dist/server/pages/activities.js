...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/activities.vue?vue&type=template&id=15f6d35a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._l((_vm.slices),function(slice,index){return _vm._ssrNode("<div>","</div>",[(slice.slice_type === 'banner')?[_c('Banner',{attrs:{"slice":slice}})]:_vm._e()],2)}),_vm._ssrNode(" "),_c('Nav'),_vm._ssrNode(" <h1 class=\"uk-heading-primary\">"+_vm._ssrEscape(_vm._s(_vm.$prismic.asText(_vm.activities.title)))+"</h1> <div"+(_vm._ssrAttr("data-src",_vm.activities.image.url))+" uk-img class=\"uk-height-large uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light\"></div> "),_c('prismic-rich-text',{attrs:{"field":_vm.activities.content}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/activities.vue?vue&type=template&id=15f6d35a&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/activities.vue?vue&type=script&lang=js&
//
//
//
//
